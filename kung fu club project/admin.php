...
<div id="page">
  ...
  <div><a href="index.php"><img src="images/skfnew.png" alt="" /></a>Stephanos Kung Fu Club</div>
 ...
 <button type="submit" float="right"><a href="/Registration-form/Register.php">Register</a></button>
    ...
    <ul>
      ...
      <li><a href="training-courses.html">Classes</a></li>
      <li><a href="school-calendar.html">Ranks</a></li>
...
<div>
          ...
          <ul>
            <li>
              ...
              <p>Is to train students in Kung Fu and </p>
            ...
            <li>
              <h2><a href="#">Nam a mauris <span class="last">Pellentesque</span></a></h2>s
